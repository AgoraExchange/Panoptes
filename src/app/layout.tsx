...
const SITE_URL = "https://panoptes.agora.exchange";
const SITE_NAME = "Panoptes";
const SITE_TITLE = "Panoptes - Global Intelligence Platform | Live Flight Tracking, CCTV, OSINT Tools & More";
const SITE_DESCRIPTION = "A real-time global intelligence dashboard managed by Agora Exchange. Track aircraft, satellites, worldwide CCTV cameras, earthquakes, wildfires, nuclear facilities, cyber threats, market signals, and global conflicts from a single GPU-accelerated interface.";
...
export const metadata: Metadata = {
  ...
  title: {
    default: SITE_TITLE,
    template: "%s | Panoptes Intelligence",
  },
  ...
  keywords: [
    ...
    // Brand
    "panoptes", "agora exchange", "panoptes intelligence",
  ],
  authors: [{ name: "Agora Exchange", url: SITE_URL }],
  creator: "Agora Exchange",
  publisher: "Agora Exchange",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    title: "Panoptes - Global Intelligence Platform | Live Flights, CCTV, Satellites & OSINT Tools",
    description: SITE_DESCRIPTION,
    type: "website",
    siteName: SITE_NAME,
    locale: "en_US",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Panoptes global intelligence platform with live tracking and OSINT tools",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "Panoptes - Global Intelligence Platform | Live Tracking + OSINT Tools",
    description: SITE_DESCRIPTION,
    creator: "@AgoraExchange",
    site: "@AgoraExchange",
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "Panoptes",
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: "Panoptes - OSINT Toolkit & Intelligence Platform",
  alternateName: ["Panoptes", "Panoptes Intelligence", "Agora Exchange Panoptes"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
